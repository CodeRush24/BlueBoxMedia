import logo1 from '../assets/BlueBoxMedia.png'
...
export const categories = [
    ...
    { name: 'Hindu Mythology', icon: <TempleHinduIcon />, },
    { name: 'Universe and space', icon: <RiAliensFill />, },
    { name: 'Music', icon: <MusicNoteIcon /> },
    { name: 'Sport', icon: <SportsScoreIcon />, },
    ...
    { name: 'Gaurav Katare', icon: <AutoAwesomeIcon />, },
